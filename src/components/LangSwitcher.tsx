        ...
        {({ open }) => (
          <>
            <MenuButton className="flex items-center gap-1 rounded-3xl border px-2 py-1 bg-white text-black text-xs data-[active]:ring-2 data-[active]:ring-blue-300">
              <span className="hidden sm:block">{LANGUAGE_LABELS[currentLocale].label}</span>
              <span className="block sm:hidden">{LANGUAGE_LABELS[currentLocale].code}</span>
              <ChevronDown
                className={clsx(
            ...
            >
              <MenuItems className="absolute top-full end-0 rounded bg-white p-2 shadow-lg z-10 flex flex-col gap-2 text-black">
